...
namespace AddressLocalDB {
    ...
    public partial class AddressDBDataSet : global::System.Data.DataSet {
        ...
        public partial class AddressDataTable : global::System.Data.TypedTableBase<AddressRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public AddressRow AddAddressRow(int ID, string Name, string Address, string Phone) {
...
namespace AddressLocalDB.AddressDBDataSetTableAdapters {
    ...
    public partial class AddressTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Address] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Address] ([ID], [Name], [Address], [Phone]) VALUES (@ID, @Name" +
                ", @Address, @Phone);\r\nSELECT ID, Name, Address, Phone FROM Address WHERE (ID = @" +
                "ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Address] SET [ID] = @ID, [Name] = @Name, [Address] = @Address, [Phone] = @Phone WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT ID, Name, Address, Phone FROM Address WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AddressLocalDB.Properties.Settings.Default.AddressDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Address, Phone FROM dbo.Address";
        ...
        public virtual int Fill(AddressDBDataSet.AddressDataTable dataTable) {
        ...
        public virtual AddressDBDataSet.AddressDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AddressDBDataSet.AddressDataTable dataTable = new AddressDBDataSet.AddressDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AddressDBDataSet.AddressDataTable dataTable) {
